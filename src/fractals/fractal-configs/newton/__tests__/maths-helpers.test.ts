import { cByC, pow2, pow3, pow4, pow5, rxC, sumComplex } from "../maths-helpers";
...
describe('should correctlymultiply real number as comples number represented by array', () => {
...
describe('should sum an array of number as complex number represented by array', () => {
  it('should correctly add real numbers', () => {
    expect(sumComplex([[3, 0], [4, 0], [5, 0] ])).toStrictEqual([12, 0])
  });

  it('should correctly add imaginary numbers', () => {
    expect(sumComplex([[0, 3], [0, 5], [0, 60] ])).toStrictEqual([0, 68])
  });

  it('should correctly add complex numbers', () => {
    expect(sumComplex([[1, 3], [2, 5], [3, 60] ])).toStrictEqual([6, 68])
  });
});
